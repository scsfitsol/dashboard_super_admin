                ...
                <tbody>
                    <tr className="row1">
                        ...
                        <td className="column7 style90 s style95" colSpan="3" rowSpan="3">FITSOL SUPPLY CHAIN SOLUTIONS PRIVATE LIMITED<br />
                            <p style={{ fontWeight: 'bold', color: '#000000', fontSize: '12pt' }}>
                                Arjun MLU Plaza,Plot No 7, S-204 ,Sector-5,Dwarka New Delhi, 110075
                            </p>
                        </td>
                    </tr>
                    <tr className="row2">
                    ...
                    <tr className="row4">
                        ...
                        <td className="column5 style87 s style87" colSpan="2">Dated : {moment(new Date()).format('LL')}</td>
                        <td className="column7 style71 s style73" colSpan="3">Vehicle No : {trip?.vehicle?.registrationNumber}</td>
                    </tr>
                    <tr className="row5">
                        <td className="column1 style2 null"></td>
                        <td className="column2 style3 null">{trip?.sourceLocation}</td>
                        <td className="column3 style51 null style51" colSpan="2">{trip?.destinationLocation}</td>
                    ...
                    <tr className="row11">
                        <td className="column1 style44 s style45" colSpan="3">GST NO : {trip?.plant?.GST}</td>
                    ...
                    <tr className="row18">
                        ...
                        <td className="column2 style5 s paddingStart">{trip?.invoiceNumber}</td>
                    ...
                    <tr className="row21">
                        ...
                        <td className="column2 style19 s paddingStart">{trip?.insuranceNumber}</td>
